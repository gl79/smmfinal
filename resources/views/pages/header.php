        ...
        <div class="container-fluid container-xl">
            <div class="d-flex py-3 align-items-center justify-content-between">
                ...
                <div class="header-actions d-flex align-items-center justify-content-end">
                    ...
                    <!-- Cart -->
                    <a href="pemesanan.php" class="header-action-btn">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center ms-3">
                                    <img src="assets/img/person.webp" alt="Guest" class="rounded-circle" width="40" height="40">
                                    <span class="ms-2 fw-semibold">Guest</span>
                                </div>
                            </div>
                            <hr class="my-2">
                            <div class="dropdown-footer">
                                <a href="login-register.php" class="btn btn-primary w-100 mb-2">Masuk</a>
                                <a href="login-register.php" class="btn btn-outline-primary w-100">Daftar</a>
                            </div>
                        </div>
                    </div>
