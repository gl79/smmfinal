                  ...
                  <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="assets/img/product/instagram.webp" alt="Product" class="img-fluid" loading="lazy">
                      </div>
                      <div class="product-details">
                        <h6 class="product-title">Instagram</h6>
                        <div class="product-meta">
                          <span class="product-color">Garansi 3 Hari</span>
                        </div>
              ...
              <div class="cart-item" data-aos="fade-up" data-aos-delay="200">
                <div class="row align-items-center gy-4">
                  <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="assets/img/product/tiktok.png" alt="Product" class="img-fluid" loading="lazy">
                      </div>
                      <div class="product-details">
                        <h6 class="product-title">Tiktok</h6>
                        <div class="product-meta">
                          <span class="product-color">Garansi 15 Hari</span>
                        </div>
                        <button class="remove-item" type="button">
                          <i class="bi bi-trash"></i> Remove
                        </button>
              ...
              <div class="cart-item" data-aos="fade-up" data-aos-delay="300">
                <div class="row align-items-center gy-4">
                  <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="assets/img/product/pornhub.png" alt="Product" class="img-fluid" loading="lazy">
                      </div>
                      <div class="product-details">
                        <h6 class="product-title">Pornhub</h6>
                        <div class="product-meta">
                          <span class="product-color">Garansi 30 Hari</span>
                        </div>
                        <button class="remove-item" type="button">
                          <i class="bi bi-trash"></i> Remove
                        </button>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="cart-summary">
              ...
              <div class="summary-item">
                ...
                <span class="summary-value">IDR 269.960</span>
              </div>

              <div class="summary-item shipping-item">
                <span class="summary-label">Durasi Garansi</span>
              ...
              <div class="checkout-button">
                <a href="#" class="btn btn-accent w-100">
                  Lanjutkan Checkout <i class="bi bi-arrow-right"></i>
                </a>
              </div>
